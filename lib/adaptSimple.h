...
*/
static void initBufferAndAntiAdapt(
	ImageBuffer* imageBuffer,        // OUT image: target or corpus drawable
	Map*         pixmap,             // IN NON-rowpadded pixmap
	...
	)
{
	...
	imageBuffer->data = reinterpret_cast<unsigned char*>(calloc(reservedSize, 1));
